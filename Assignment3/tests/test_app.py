...
@pytest.mark.parametrize("bmi, category", [(0, "Error"), (.1, "Underweight"), (9.5, "Underweight"), 
    (18.4, "Underweight"), (18.5, "Normal Weight"), (21.5, "Normal Weight"), (24.9, "Normal Weight"), 
    (25, "Overweight"), (27.5, "Overweight"), (29.9, "Overweight"), (30, "Obese")])
...
@pytest.mark.parametrize("feet, inches, weight, bmi, category", [(5, 3, 100, 18, "Underweight"), 
    (5, 3, 125, 22.7, "Normal Weight"), (5, 3, 140, 25, "Overweight"), (5, 3, 180, 32.7, "Obese")])
